...
# case 1 - LGBM - first 11 features
# 'platelets_min', 	'pt_max', 	'creatinine_max', 	'temperature_vital_min', 	'bun_max', 	'inr_max', 	'inr_min', 	'anchor_age', 	'resp_rate_min', 	'bicarbonate_lab_max', 	'bun_min'

# [0.616, 0.271, 0.551, 0.364, 0.318, 0.788]
# [0.618, 0.27, 0.579, 0.368, 0.33, 0.813]

# case 2 - LGBM - first 11 features + base_platelets
# 'platelets_min', 	'pt_max', 	'creatinine_max', 	'temperature_vital_min', 	'bun_max', 	'inr_max', 	'inr_min', 	'anchor_age', 	'resp_rate_min', 	'bicarbonate_lab_max', 	'bun_min', 'base_platelets'

# [0.609, 0.259, 0.526, 0.347, 0.298, 0.789]
# [0.624, 0.284, 0.58, 0.379, 0.339, 0.813]

# case 3 - LGBM - first 14 features - so far-best
# 'platelets_min', 	'pt_max', 	'creatinine_max', 	'temperature_vital_min', 	'bun_max', 	'inr_max', 	'inr_min', 	'anchor_age', 	'resp_rate_min', 	'bicarbonate_lab_max', 	'bun_min', 	'aniongap_max', 	'wbc_max', 	'hemoglobin_lab_min'

# [0.624, 0.281, 0.589, 0.381, 0.343, 0.784]
# [0.626, 0.287, 0.588, 0.384, 0.345, 0.815]

# case 4 - LGBM - first 14 features + base_platelets
# 'platelets_min', 	'pt_max', 	'creatinine_max', 	'temperature_vital_min', 	'bun_max', 	'inr_max', 	'inr_min', 	'anchor_age', 	'resp_rate_min', 	'bicarbonate_lab_max', 	'bun_min', 	'aniongap_max', 	'wbc_max', 	'hemoglobin_lab_min' 'base_platelets'

# [0.605, 0.249, 0.527, 0.338, 0.292, 0.789]
# [0.629, 0.294, 0.59, 0.391, 0.35, 0.817]

# case 5 - LGBM - first 14 features
# 'platelets_min', 	'pt_max', 	'creatinine_max', 	'temperature_vital_min', 	'bun_max', 	'inr_max', 	'inr_min', 	'anchor_age', 	'resp_rate_min', 	'bicarbonate_lab_max', 	'bun_min', 	'aniongap_max', 	'wbc_max', 	'hemoglobin_lab_min', 	'sbp_max', 	'sbp_mean', 	'glucose_vital_min', 	'heart_rate_mean', 	'temperature_vital_mean', 	'sbp_min', 	'pt_min', 	'creatinine_min', 	'spo2_mean', 	'aniongap_min', 	'resp_rate_max', 	'mbp_max', 	'base_platelets', 	'spo2_max'

# [0.601, 0.239, 0.528, 0.329, 0.286, 0.787]
# [0.626, 0.287, 0.595, 0.386, 0.348, 0.817]
...
print('check1')
print(df_train_cat_selected_numerical_selected[:, 159:])
print(df_train_cat_selected_numerical_selected[:, 160:])
...
#                                'label_train_actual_and_predicted.csv')  # This Returns a path. os.path.join - https://www.geeksforgeeks.org/python-os-path-join-method/
#
# label_train_actual_and_predicted.to_csv(save_train_data, float_format='%.0f')
#
# save_test_data = os.path.join(output_result_dir,
#                               'label_test_actual_and_predicted.csv')  # This Returns a path. os.path.join - https://www.geeksforgeeks.org/python-os-path-join-method/
#
...
blind_test_LGBM = [blind_acc_LGBM, blind_recall_LGBM, blind_precision_LGBM, blind_f1_LGBM, blind__mcc_LGBM,
                   blind_AUC_LGBM]
print(blind_test_LGBM) # [0.624, 0.281, 0.589, 0.381, 0.343, 0.784]
...
print(confusion_matrix(y_train, y_pred).ravel()) # [8823  318 1135  456]
print(tp)  # 456
print(tn)  # 8823

print(fp)  # 318
print(fn)  # 1135
print(npv)  # 0.8860212894155453
...
print(cross_validation_LGBM) # [0.626, 0.287, 0.588, 0.384, 0.345, 0.815]
...
#------------------------------------------------------------------------------------------------------------
# python /Users/psenevirathn/PycharmProjects/myproject2/current_codes/4_Jan_3_Train_model_after_feature_selection.py /Users/psenevirathn/Desktop/PhD/Coding/Python/input_csv_files/train_data_before_preprocessing.csv /Users/psenevirathn/Desktop/PhD/Coding/Python/input_csv_files/test_data_before_preprocessing.csv
